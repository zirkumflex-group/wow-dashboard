...
export type CartesianChartProps<TData extends Row> = {
  ...
  /** Decorative animated stars inside the dither fill. */
  sparkles?: boolean;
  /** Explicit y-domain for metrics where a zero baseline would hide change. */
  yDomain?: readonly [number, number];
  /** Accessible summary for the chart graphic. */
  ariaLabel?: string;
